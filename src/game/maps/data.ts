...
const planetObstacles = {
  static: [
    { id: 'wall-north', position: [0, 1, -29] as [number, number, number], size: [29, 2, 1] as [number, number, number], material: 'hard' as const, color: '#5f6067' },
    { id: 'wall-south', position: [0, 1, 29] as [number, number, number], size: [29, 2, 1] as [number, number, number], material: 'hard' as const, color: '#5f6067' },
    { id: 'wall-east', position: [29, 1, 0] as [number, number, number], size: [1, 2, 29] as [number, number, number], material: 'hard' as const, color: '#5f6067' },
    { id: 'wall-west', position: [-29, 1, 0] as [number, number, number], size: [1, 2, 29] as [number, number, number], material: 'hard' as const, color: '#5f6067' },
  ],
  movable: [
    { id: 'cone-1', position: [5, 0.45, 2] as [number, number, number], size: [0.7, 0.9, 0.7] as [number, number, number], material: 'soft' as const, movable: true, color: '#f2871b' },
    { id: 'cone-2', position: [-3, 0.45, 7] as [number, number, number], size: [0.7, 0.9, 0.7] as [number, number, number], material: 'soft' as const, movable: true, color: '#f2871b' },
    { id: 'crate-1', position: [4, 0.6, -8] as [number, number, number], size: [1, 1.2, 1] as [number, number, number], material: 'medium' as const, movable: true, color: '#c7904a' },
    { id: 'crate-2', position: [-13, 0.6, 12] as [number, number, number], size: [1, 1.2, 1] as [number, number, number], material: 'medium' as const, movable: true, color: '#c7904a' },
  ],
}
...
export const FIXED_MAPS: Record<Exclude<MapId, 'procedural'>, TrackMap> = {
  ...
  titan: {
    ...
    spawnRules: {
      ...
      obstacles: {
        static: [...planetObstacles.static, { id: 'truck-1', position: [10, 1, 5], size: [2, 2, 4], material: 'hard', color: '#2f3348' }],
        movable: [...planetObstacles.movable, { id: 'crate-3', position: [14, 0.6, -13], size: [1, 1.2, 1], material: 'medium', movable: true, color: '#c7904a' }],
      },
    },
    gates: [
